...
urlpatterns = [
    ...
    url(r'^Predict_Traffic_Incident_Type/$', remoteuser.Predict_Traffic_Incident_Type, name="Predict_Traffic_Incident_Type"),
    ...
    url(r'^View_Traffic_Incident_Type_Ratio/$', serviceprovider.View_Traffic_Incident_Type_Ratio, name="View_Traffic_Incident_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Traffic_Incident_Type/$', serviceprovider.View_Traffic_Incident_Type, name="View_Traffic_Incident_Type"),
